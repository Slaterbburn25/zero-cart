      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        ...
        <div style={{ marginTop: '1rem' }}>
           <button 
              ...
              style={{ padding: '1.2rem', fontSize: '1.1rem', boxShadow: '0 4px 15px rgba(16, 185, 129, 0.3)', opacity: isBuilding ? 0.7 : 1, cursor: isBuilding ? 'not-allowed' : 'pointer' }}
           >
              {isBuilding ? 'Constructing Shopping Matrix...' : '▶ DISPATCH AI AUTONOMY'}
           </button>
